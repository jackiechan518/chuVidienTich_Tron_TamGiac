 ...
 * @author ACER
 */
public class CalculateAreaCircle extends javax.swing.JFrame {

    /**
     * Creates new form CalculatePerimeter
     */
    public CalculateAreaCircle() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TÍNH DIỆN TÍCH HÌNH TRÒN");
    ...
    private void calculatePerimeterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calculatePerimeterActionPerformed
        ...
        double s = (double)rCircle*rCircle*3.14;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalculateAreaCircle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CalculateAreaCircle().setVisible(true);
            }
        });
    }

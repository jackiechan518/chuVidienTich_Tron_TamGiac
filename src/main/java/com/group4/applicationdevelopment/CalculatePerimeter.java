 ...
 * @author ACER
 */
public class CalculatePerimeter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TÍNH CHU VI TAM GIÁC");
        ...
        calculatePerimeter.setText("Tính Chu Vi");
    ...
    private void calculatePerimeterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calculatePerimeterActionPerformed
        ...
        noticeLabel.setText(String.valueOf(perimeter));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalculatePerimeter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CalculatePerimeter().setVisible(true);
            }
        });
    }
